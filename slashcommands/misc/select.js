const { SlashCommandBuilder, SelectMenuBuilder, ActionRowBuilder, SelectMenuOptionBuilder, Client, Interaction } = require('discord.js');
  ...
  async execute(interaction, client) {
    const menu = new SelectMenuBuilder()
      ...
      .setOptions(
        ...
        new SelectMenuOptionBuilder().setLabel(`DarkVividPink`).setValue('DarkVividPink'),
        new SelectMenuOptionBuilder().setLabel(`Green`).setValue('Green'),
        new SelectMenuOptionBuilder().setLabel(`LuminousVividPink`).setValue('LuminousVividPink'),
    ...
    interaction.reply({ content: 'Select Color:', components: [new ActionRowBuilder().addComponents(menu)] });
  },
};
