...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (week < 1) return interaction.reply({ embeds: [{ color: 16711680, description: `\\❌ | Số tuần phải lớn hơn 0` }], ephemeral: true });

    if (!client.checkURL(imgURL))
      return interaction.reply({ embeds: [{ color: 16711680, description: `\\❌ | Vui lòng nhập chính xác Image URL` }], ephemeral: true });
