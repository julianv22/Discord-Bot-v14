...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addChannelOption(opt => opt.setName('total-count-channel').setDescription('Total Count Channel').setRequired(true))
    .addChannelOption(opt => opt.setName('members-count-channel').setDescription('Members Count Channel').setRequired(true))
    ...
    .addChannelOption(opt => opt.setName('presences-count-channel').setDescription('Presences Count Channel').setRequired(true)),
  category: 'moderator',
