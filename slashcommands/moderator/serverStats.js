...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addChannelOption((opt) =>
      opt
        .setName("total-count-channel")
        .setDescription("Total Count Channel")
        .setRequired(true)
    )
    .addChannelOption((opt) =>
      opt
        .setName("members-count-channel")
        .setDescription("Members Count Channel")
        .setRequired(true)
    )
    .addRoleOption((opt) =>
    ...
    .addChannelOption((opt) =>
      opt
        .setName("bots-count-channel")
        .setDescription("Bots Count Channel")
        .setRequired(true)
    )
    .addRoleOption((opt) =>
      opt.setName("bot-role").setDescription("Bot Role").setRequired(true)
    )
    .addChannelOption((opt) =>
      opt
  ...
  async execute(interaction, client) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail(
        "https://emoji.discadia.com/emojis/5dc63f16-97b4-402e-8d1f-a76e15fdd6ab.png"
      )
      .setTimestamp()
      .addFields(
