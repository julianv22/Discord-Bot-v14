      ...
      .then(body => {
        if (body.message)
          return interaction.reply({
            embeds: [{ color: 16711680, description: `\\❌ | Can not find this user!` }],
            ephemeral: true,
          });
        ...
        const embed = new EmbedBuilder()
          ...
          .addFields([
            ...
            { name: 'Account Created', value: moment.utc(created_at).tz('Asia/Ho_Chi_Minh').format('HH:mm ddd, Do MMMM YYYY'), inline: true },
          ])
