...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const embed = new EmbedBuilder()
      .setAuthor({ name: 'Donate for Julian-V', iconURL: thumb, url: cfg.youtube })
      ...
      .setImage(img)
      .addFields([
        { name: 'Donate', value: '[PlayerDuo](https://playerduo.com/julianvduo)', inline: true },
        { name: 'Momo', value: '[0974.626.222](https://me.momo.vn/vjIyu4FJf2sMtqsQtptn)', inline: true },
        { name: 'Tip', value: '[StreamElements](https://streamelements.com/julianv-4174/tip)', inline: true },
      ])
