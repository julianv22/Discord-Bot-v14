...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    interaction.reply({
      embeds: [{ color: 16711680, description: `\\🚫 | Suggestion has been denied! [[Jump Link](${msg.url})]` }],
      ephemeral: true,
    });
    ...
    author
      .send({
        embeds: [
          new EmbedBuilder()
            .setAuthor({ name: 'Deny suggestion', iconURL: 'https://emoji-uc.akamaized.net/orig/91/688d0305a605a283b2e17e04834192.png' })
