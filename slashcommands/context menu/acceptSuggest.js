  ...
  async execute(interaction, client) {
    ...
    if (msg.author.id !== cfg.clientID)
      return interaction.reply({
        embeds: [{ color: 16711680, description: `\\❌ | This messages does not belong to ${bot}!` }],
        ephemeral: true,
      });
    ...
    const edit = EmbedBuilder.from(embed)
      ...
      .spliceFields(0, 1)
      .setTimestamp()
      .setFooter({ text: `Đề xuất đã được chấp nhận`, iconURL: 'https://cdn3.emoji.gg/emojis/4240-verified-green-animated.gif' });
    await msg.edit({ embeds: [edit] });

    interaction.reply({
      embeds: [{ color: 65280, description: `\\✅ | Suggestion has been accepted! [[Jump Link](${msg.url})]` }],
      ephemeral: true,
    });
    ...
    author
      .send({
        embeds: [
          new EmbedBuilder()
            .setAuthor({ name: 'Accept suggestion', iconURL: 'https://cdn3.emoji.gg/emojis/4240-verified-green-animated.gif' })
