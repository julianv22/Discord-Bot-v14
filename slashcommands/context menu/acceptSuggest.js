...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (footer !== `${guild.name} Suggestion` && footer === 'Suggestion accepted')
      return await interaction.reply(embedMessage({ desc: 'This suggestion has been accepted!' }));
    ...
    await interaction.reply(embedMessage({ desc: 'Suggestion has been accepted!', emoji: true }));
  },
};
