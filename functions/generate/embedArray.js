...
module.exports = client => {
  ...
  client.embedArray = function embedArray(message, args) {
    try {
      ...
      let res = [
        {
          author: { name: author.username, icon_url: author.displayAvatarURL(true) }, // Set Author
      ...
      if (args[2]) {
        res[0].footer = { text: args[2], icon_url: message.guild.iconURL(true) }; // Set Footer
      ...
      console.error(chalk.yellow.bold('Error while runing embedArray'), e);
