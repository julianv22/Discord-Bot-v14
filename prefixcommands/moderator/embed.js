...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    const embedGuide = new EmbedBuilder()
      ...
      .addFields([
        ...
        },
        {
          ...
          value: `\`\`\`fix\n${
            prefix + this.name
          } Title | Description | Footer | ThumbnailURL | ImageURL\`\`\``,
        },
        {
          name: "Edit embed:",
          value: `\`\`\`fix\n${
        ...
        },
        {
          name: "ThumbnailURL:",
          value:
            "Ảnh thumbnail góc bên phải embed *(nếu không set có thể bỏ trống)*",
        },
        {
          name: "ImageURL:",
    ...
    if (argEdit[0] === "edit") {
      const msgEdit = await message.channel.messages
        .fetch(argEdit[1])
        .catch(() => undefined);
